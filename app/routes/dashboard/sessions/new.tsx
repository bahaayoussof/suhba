...
import Step6Success from "../../../components/sessionsForm/Step6";
          ...
          {currentStep === 6 ? (
            <div className="flex items-center gap-4 w-full justify-center">
              <button
                ...
                className="px-8 py-3 bg-[var(--deep-teal-900)] text-white font-bold rounded-[10px] shadow-sm hover:bg-[#033b47] transition-colors"
              >
                الذهاب لمجالسي
              </button>
              <button
                onClick={() => { resetWizard(); navigate("/dashboard/worlds"); }}
                className="px-8 py-3 bg-white text-[var(--deep-teal-900)] font-bold rounded-[10px] border border-[var(--deep-teal-900)] hover:bg-slate-50 transition-colors"
              >
                استكشاف العوالم
              </button>
            </div>
